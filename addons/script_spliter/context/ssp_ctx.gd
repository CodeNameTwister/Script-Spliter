...
const PLUS_SPLIT = preload("res://addons/script_spliter/context/icons/plus_split.svg")
const MINUS_SPLIT = preload("res://addons/script_spliter/context/icons/minus_split.svg")
const SspEditor = preload("res://addons/script_spliter/context/ssp_editor.gd")
